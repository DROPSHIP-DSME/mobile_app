            ...
            <ScrollView onScroll={({nativeEvent}) => {
             ...
             <View style={{flexDirection:"row",marginHorizontal:"4%",marginTop:"9%"}}>
              ...
              <TouchableOpacity onPress={() => props.navigation.navigate("Accountview2") } style={{height:35,width:35,backgroundColor:'#e6e6e6',borderRadius:4,padding:7}}>
                  <Image source={ImageIcons.ordercopytoday}  style={{height:15,width:15,marginTop:5,alignSelf:'center'}} />
                </TouchableOpacity> 
              </View> 
             ...
             <View style={{borderBottomWidth:1.5,marginTop:"8%",marginHorizontal:"3%",borderColor:"#B3B3B3"}}></View>
