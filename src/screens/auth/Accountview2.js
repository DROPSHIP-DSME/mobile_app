    ...
    return (
        <KeyboardAvoidingView
            ...
            <ScrollView onScroll={({nativeEvent}) => {
             ...
             <View style={{flexDirection:"row",marginHorizontal:"4%",marginTop:"9%"}}>
              ...
              <Text style={{fontSize:15,fontFamily:"hinted-AvertaStd-Regular",color:"#999999"}}>VIEW ORDER /</Text>
              <Text style={{fontSize:15,fontFamily:"hinted-AvertaStd-Regular",color:"#1A1A1A"}}>CHAT WITH SELLER</Text>
              </View>
              ...
              <View style={{flexDirection:'row',marginTop:'5%',marginHorizontal:'4%'}}>
                 ...
                 <View style={{flexDirection:'row',justifyContent:'space-between',marginTop:'3%'}}>
                     <Text style={{fontSize:20,color:'#1a1a1a',fontFamily:'hinted-AvertaStd-Semibold',}}>Chat with Seller</Text>
               ...
               <View style={{flexDirection:"row",justifyContent:"space-between",marginHorizontal:"4%",marginTop:'5%',marginBottom:'30%'}}>
                <View style={{justifyContent:'space-between',}}>
                 <Text style={{fontSize:20,color:'#1a1a1a',fontFamily:'hinted-AvertaStd-Semibold'}}>Billing Information</Text>
                  <Text style={{fontSize:16,fontFamily:"hinted-AvertaStd-Regular",color:"#1A1A1A",top:-15}}>Same as shipping address</Text>
               </View>

                <View style={{marginLeft:8}}>
                 <Text style={{fontSize:20,color:'#1a1a1a',fontFamily:'hinted-AvertaStd-Semibold',}}>Payment</Text>
                  <Text style={{fontSize:16,fontFamily:"hinted-AvertaStd-Semibold", color:"#1A1A1A",}}>US$0
        ...
        <View style={{flex:1,backgroundColor:'#ffffff',paddingVertical:10,borderRadius:10,zIndex:4001, position:'absolute',bottom:'20%',margin:"5%"}}>
         ...
         <TouchableOpacity style={{position:'absolute',right:15}} onPress={() => closebagpopup()}>
            ...
            <View style={{marginLeft:"2%"}}>
                    <Text style={{fontSize:20,fontStyle:'normal',fontWeight:"bold", marginVertical:'2%',fontFamily:'hinted-AvertaStd-Regular',color:'#1A1A1A'}}>$52.50</Text>
            </View>
