    ...
    return (
       ...
       <ScrollView onScroll={({nativeEvent}) => {
             ...
             <TouchableOpacity onPress={() => props.navigation.navigate("Dashwith")} style={{flexDirection:'row',justifyContent:'space-between',marginHorizontal:'4%',}}>
                 <Text style={{fontSize:26,color:'#1a1a1a',fontFamily:'hinted-AvertaStd-Semibold',}}>Withdrawals</Text>
               </TouchableOpacity>

              <View style={styles.pickerViewshorttodayAdvertise}>
              <Text style={{fontSize:12,fontFamily:'hinted-AvertaStd-Regular',color:'4d4d4d',marginLeft:'3%',marginTop:'2%'}}>Choose a Bank Account</Text>
                      <Picker
                ...
                <View style={styles.pickerViewshorttodayAdvertise}>
              <Text style={{fontSize:12,fontFamily:'hinted-AvertaStd-Regular',color:'4d4d4d',marginLeft:'3%',marginTop:'2%'}}>Amount to Withdraw</Text>
                      <Picker
                        selectedValue={selectedValue}
                        style={{ height: 20, width: 320,color:'#4d4d4d',}}
                        onValueChange={(itemValue, itemIndex) =>setSelectedValue(itemValue)}
              ...
              <Text style={{fontSize:12,fontFamily:'hinted-AvertaStd-Regular',color:'4d4d4d',marginLeft:'3%',marginTop:'2%'}}>Amount to Deposit*</Text>
              <Text style={{fontSize:18,fontFamily:'hinted-AvertaStd-Regular',color:'4d4d4d',marginLeft:'3%',marginTop:'1%'}}>US$</Text>       
                </View>
