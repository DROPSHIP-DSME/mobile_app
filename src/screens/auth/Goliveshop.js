        ...
        <KeyboardAvoidingView
            ...
            <Image source={ImageIcons.logored_1} style={styles.setlogonewdata}  />
                    ...
                    <View style={{justifyContent:'center',marginHorizontal:'3%',marginTop:'10%'}}>
                        <Text style={[styles.LIVEpeopleshop,{fontSize:26}]}>People buy more when they can see a product, live!</Text>
                    </View>
                ...
                <View style={{alignItems:'center',marginTop:'4%'}}>
                    <TouchableOpacity
                        ...
                        <View style={{flexDirection:'row',  justifyContent:'center',padding:10}}>
                            <Image source={ImageIcons.emailing} style={{ width:20,height:20,marginLeft:'2%'}} />
                            <Text style={[styles.startbutton1,{marginLeft:25,color:'#000000'}]}>CONTINUE WITH EMAIL</Text>
                        </View>
                    </TouchableOpacity>
                </View>
                ...
                <View style={{alignItems:'center',marginTop:'4%'}}>
                    <TouchableOpacity
                        ...
                        <View style={{flexDirection:'row',  justifyContent:'center',padding:10}}>
                            <Image source={ImageIcons.etsy} style={{ width:30,height:23,marginLeft:'2%',marginTop:'2%'}} />
                            <Text style={[styles.startbutton1,{fontSize:13,marginLeft:10,marginTop:5,color:'#000000'}]}>CONTINUE WITH ETSY</Text>
                        </View>
                    </TouchableOpacity>
                </View>
                ...
                <View style={{alignItems:'center',marginTop:'4%',marginBottom:'4%'}}>
                    <TouchableOpacity
                        ...
                        onPress={() => alert('Coming Soon!')}>
                        <View style={{flexDirection:'row',  justifyContent:'center',padding:10}}>
                            <Image source={ImageIcons.wooCommerce} style={{ width:45,height:23,}} />
                            <Text style={[styles.startbutton1,{fontSize:13,marginLeft:20,color:'#000000'}]}>CONTINUE WITH WOOCOMMERCE</Text>
                        </View>
                    </TouchableOpacity>
                </View>
