  ...
  return (
    <KeyboardAvoidingView
      ...
      <ScrollView onScroll={({ nativeEvent }) => {
        ...
        <View style={{ borderColor: '#e6e6e6', borderRadius: 10, width: deviceWidth / 1.1, backgroundColor: '#e6e6e6', height: 55, alignSelf: 'center', marginTop: '7%', backgroundColor: "#e6e6e6", marginHorizontal: "3%" }}>
        ...
        <View style={{ flexDirection: 'row', marginHorizontal: '4%' }}>
          <View style={{ height: 15, width: 15, backgroundColor: '#848484', borderRadius: 3, }}></View>
          <Text style={{ fontSize: 16, fontFamily: 'hinted-AvertaStd-Regular', color: '#1a1a1a', marginLeft: 5 }}>Save payment method</Text>
        </View>
