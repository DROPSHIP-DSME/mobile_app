        ...
        <StatusBar backgroundColor={showclassName} barStyle="dark-content" translucent={true} />
            ...
            <ScrollView onScroll={({nativeEvent}) => {
             ...
             <View style={{marginHorizontal:'3%',marginTop:'20%',flexDirection:"row"}}>
              ...
              <Text style={{fontSize:26,color:'#1A1A1A',paddingVertical:'1%',lineHeight:30,fontWeight:'bold',fontFamily:'SourceSansPro-Regular',fontStyle:'normal'}}>Payment Information</Text>
              </View> 
              ...
              <Text style={{fontSize:18,fontFamily:'SourceSansPro-Regular',color:'4d4d4d',marginLeft:'5%',marginTop:'1%'}}>Mary</Text>       
                ...
                <View style={{flexDirection:'row',marginHorizontal:'4%'}}>
                <View style={{height:15,width:15,backgroundColor:'#848484',borderRadius:3,}}></View>
                 <Text style={{fontSize:16,fontFamily:'SourceSansPro-Regular',color:'#1a1a1a',marginLeft:5}}>Save payment method</Text>
               </View>
             ...
             <View>
              ...
              <View style={[styles.pickerViewshorttodaybrand,{marginTop:'7%',backgroundColor:"#e6e6e6",marginHorizontal:"3%",borderRadius:10}]}>
                ...
                <View style={[styles.pickerViewshorttodaybrand,{marginTop:'7%',backgroundColor:"#e6e6e6",marginHorizontal:"3%",borderRadius:10,flexDirection:"row",justifyContent:"space-between"}]}>
                 <TextInput 
                 ...
                 <Image source={ImageIcons.ques} style={{width:21,height:21}}/>
                 </View>
                </View>
          ...
          <View style={{marginHorizontal:"3%",marginTop:"4%",bottom:5,elevation:1,}}> 
                  ...
                  <Text style={{color:"#1A1A1A",fontSize:18,fontFamily:'SourceSansPro-Bold'}}>US$232.50</Text>
                    ...
                    <TouchableOpacity  onPress={() => props.navigation.navigate("confirpayment")} style={{width:deviceWidth/1.05, backgroundColor:"#B80000",borderRadius:30,marginTop:"3%",height:38  }} >
                    <Text style={{textAlign:'center',color:"#FFFFFF",fontWeight:'bold',fontSize:18,top:8}}>CONFIRM PAYMENT</Text> 
                    </TouchableOpacity>
              </View>
          { visiblebag ==true &&
