...
const styles = StyleSheet.create({
  ...
  shopmodalinput: {
    backgroundColor: '#E6E6E6', borderRadius: 10, height: 55, paddingLeft: 10
  },
  shop_namestore_reviewinput: {
    borderRadius: 10, backgroundColor: '#E6E6E6', color: '#000000',
    paddingLeft: 10, textAlignVertical: 'top'
  },
  map: {
  ...
  btnfllow: {
    backgroundColor: '#b80000', marginBottom: '20%', width: deviceWidth / 1.1,
  ...
  shoprating_avgtext: {
    fontSize: 18, marginHorizontal: '2%', color: '#000000', fontWeight: 'bold',
    fontStyle: 'normal', fontFamily: 'hinted-AvertaStd-Regular',
  },
  listcategory: {
  ...
  shopchatViewrose: {
    flexDirection: 'row', marginVertical: '3%', justifyContent: 'space-between'
  },
  chatViewrose: {
    flexDirection: 'row', marginTop: '8%', marginBottom: '5%'
  },
  shop_reportmodal: {
    backgroundColor: '#f2f2f2', borderWidth: 1, borderColor: '#E6E6E6', padding: '3%', borderRadius: 12
  },
  shop_reportmodaltext: {
    color: '#1A1A1A', fontFamily: 'hinted-AvertaStd-Regular', fontWeight: '400',
    fontSize: 16, fontStyle: 'normal', lineHeight: 19, alignSelf: 'center'
  },
  shop_reportmodal_radiobutton: {
    flexDirection: "row", elevation: 1, marginHorizontal: "1%", backgroundColor: "#FAFAFA", paddingVertical: '2%', borderRadius: 10,marginVertical:'3%'
  },
  shop_reportmodal_radiobutton_text: {
    paddingTop: "2%", fontSize: 16, fontFamily: "hinted-AvertaStd-Bold", fontWeight: "600", color: "#B80000", lineHeight: 23, paddingHorizontal: "2%"
  },
  shop_reportmodal_radiobutton_text2: {
    paddingTop: "2%", fontSize: 16, fontFamily: "hinted-AvertaStd-Regular", fontWeight: "400", color: "#808080", lineHeight: 23, paddingHorizontal: "2%"
  },
  shop_reportmodal_radiobutton_textinput:{
     backgroundColor: '#E6E6E6', borderRadius: 10, paddingHorizontal: '3%',
      fontSize: 16,textAlignVertical:'top',
      lineHeight: 23, letterSpacing: -0.125172, height: 100, color: '#878787', 
      fontWeight: '400', fontStyle: 'normal', fontFamily: 'hinted-AvertaStd-Regular' 
},
  labelview: {
  ...
  clothpop: {
    fontSize: 22, color: '#1A1A1A', paddingVertical: '1%', lineHeight: 30, fontWeight: 'bold', fontFamily: 'hinted-AvertaStd-Regular', fontStyle: 'normal',
  },
  shopreviewtext: {
    fontSize: 18, color: '#1A1A1A', paddingVertical: '1%', lineHeight: 30,
