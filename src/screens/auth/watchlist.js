        ...
        <KeyboardAvoidingView
            ...
            <ScrollView onScroll={({ nativeEvent }) => {
                ...
                <View >
                    ...
                    <View style={tw.style('flex flex-row justify-items-center my-2 px-1 pt-1 border-zinc-400 border-b-2 {text-color:`${item.color}}')}>
                        ...
                        {livestream ?
                            <TouchableOpacity onPress={() => Showlivestrem()}>
                                <Text style={tw.style('font-lg text-red-700 px-2 border-b-2 border-zinc-600')}>Livestreams</Text>
                            </TouchableOpacity >
                            :
                            <TouchableOpacity onPress={() => Showlivestrem()}>
                        ...
                        {product ?
                            <TouchableOpacity onPress={() => Showproduct()}>
                                <Text style={tw.style('font-lg text-red-700 px-2 border-b-2 border-zinc-600')}>Products</Text>
                            </TouchableOpacity >
                            :
                            <TouchableOpacity onPress={() => Showproduct()}>
                        ...
                        {store ?
                            <TouchableOpacity onPress={() => Showstores()}>
                                <Text style={tw.style('font-lg text-red-700 px-2 border-b-2 border-zinc-600')}>Stores</Text>
                            </TouchableOpacity >
                            :
                            <TouchableOpacity onPress={() => Showstores()}>
                                <Text style={tw.style('text-zinc-400 px-2 font-lg')}>Stores</Text>
                            </TouchableOpacity >
                        }
                        {shop ?
                            <TouchableOpacity onPress={() => Showshops()}>
                                <Text style={tw.style('font-lg text-red-700 px-2 border-b-2 border-zinc-600')}>Shops</Text>
                            </TouchableOpacity >
                            :
                            <TouchableOpacity onPress={() => Showshops()}>
                                <Text style={tw.style('text-zinc-400 px-2 font-lg')}>Shops</Text>
                            </TouchableOpacity >
                        }
