    ...
    const Header = () => {
        return (
            <View style={{ marginTop: Platform.OS == 'android' ? 30 : 60,zIndex:1001, paddingTop:30,position:'relative',flexDirection: 'row', justifyContent: 'space-between',marginHorizontal:'5%' }}>
                ...
                <View style={{ width:'60%'}}>
                    <Text style={{fontFamily:'SourceSansPro-SemiBold',color:'#ffffff',fontSize:20}}>50% off Friday Sale!</Text>
                    <Text style={{fontFamily:'SourceSansPro-SemiBold',color:'#ffffff',fontSize:16}}>SNEAKERS STORE</Text>
                </View>
                <View style={{ width:'40%'}}>
                    ...
                    <View style={{backgroundColor:'#AFFFE2',borderRadius:5,position:'absolute',top:10,left:"60%",flexDirection:"row"}}>
                        ...
                        <Text style={newstyles.shorttest}>45.8K</Text>
                    </View>
                </View>
       ...
       return(
        <View style={newstyles.Viewcart2} >
            ...
            <View>
                ...
                :
                    <Text style={newstyles.beautygreytext}>Quantity : 1</Text>
                }
        ...
        return (
                ...
                <StatusBar backgroundColor={'#B80000'} barStyle="dark-content" translucent={true} />
                 <View style={{justifyContent:'space-between', zIndex:1010,position:'absolute',top:140, right:15, textAlign:'center'}}>
                    ...
                    <View style={{marginBottom:1,marginRight:7,marginTop:-10}}>
                        ...
                        <Text style={[newstyles.liketext,{marginTop:-10}]}>34{purchaseCount}</Text>
                    </View> 
                    </TouchableOpacity>
                ...
                <View style={{ justifyContent: 'flex-end', flex: 1, marginHorizontal: 6, }}>
                    <View style={{ justifyContent: 'flex-end', flexDirection:'row', marginBottom: 1 }}>
                        ...
                        <View style={{marginVertical:'5%',right:5}}>
                            ...
                            <View style={{ flexDirection:'row',width:65,marginTop:-30, alignItems:'center', justifyContent:'center',textAlign:'center',paddingVertical:8,marginBottom:1,borderRadius:10,marginTop:0,marginLeft:10,backgroundColor:'#B80000'}}>
                                <Image source={ImageIcons.callbag}  />
                                <Text style={[newstyles.yellowboxtextnew,{fontSize:13,paddingTop:8}]}>5</Text>
                            </View>
            ...
            { Addpayment  &&
                ...
                { showsidebar  &&
                    ...
                    <View>
                        <Text style={{fontFamily:'SourceSansPro-SemiBold',fontSize:15,fontWeight:'600', color:'#000000',}}>{sidevalue}</Text>
                        ...
                        <TouchableOpacity style={{backgroundColor:'#FFB3B3',borderRadius:10,alignSelf:'center',marginVertical:'2%'}} onPress={()=>hidesidebar()}>
                            <Text style={{fontFamily:'SourceSansPro-SemiBold',fontSize:14,fontWeight:'600',paddingHorizontal:'4%', color:'#333333',textAlign:'center'}}>Ok</Text>
                        </TouchableOpacity>
                    </View>
                    </Modal>
                    </Portal>
