...
const Footer3 = (props) => {
    ...
    return (
        ...
        <View style={styles.footerView}>
         ...
         <View style={styles.maincartviewfooter}>
          ...
          <TouchableOpacity onPress={() => { navigation.navigate('watchlist'); }}>
            {onSelection==1 ?
                <View>
                     <Image source={ImageIcons.home}  style={[styles.home2,{marginTop:2}]} />
        ...
        <TouchableOpacity onPress={() => navigation.navigate("shop")} >
            {onSelection==3 ?
                <View>
                     <Image source={ImageIcons.shopfooter}  style={[styles.home2,{tintColor:'#b80000'}]} />
                     <Text style={styles.customertextrednew}>Shop</Text>
                </View>
             :
                 <View>
                     <Image source={ImageIcons.shopfooter}  style={styles.home2} />
                     <Text style={styles.customertext}>Shop</Text>
                </View>
            }

        </TouchableOpacity>

        <TouchableOpacity onPress={() => { navigation.navigate('Popevent'); }}>
         {onSelection==4 ?
             <View>
                 <Image source={ImageIcons.event}  style={[styles.home2,{tintColor:'#b80000'}]} />
                 <Text style={styles.customertextrednew}>Events</Text>         
            </View>
        :
            <View>
                 <Image source={ImageIcons.event}  style={styles.home2} />
                 <Text style={styles.customertext}>Events</Text>         
            </View>
        }
        </TouchableOpacity>
