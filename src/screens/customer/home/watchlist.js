...
import { Text, View,TouchableOpacity,Image,TextInput,FlatList, ImageBackground, ScrollView, Alert,   KeyboardAvoidingView, Platform,Keyboard,StatusBar} from 'react-native';
    ...
    return (
        <KeyboardAvoidingView
            ...
            <View >
                ...
                <View style={[styles.maincartview,{marginTop:'3%'}]}>
                    <TouchableOpacity onPress={() => newtrending()}>
                        <View style={{flexDirection:'row'}}>
                            <Text style={styles.boldproduct}>Trending Now</Text>
                        </View>
                    </TouchableOpacity>
                    <TouchableOpacity>
                        <Text style={styles.salestext}>SEE ALL</Text>
                    </TouchableOpacity>
                </View>
                ...
                <View style={styles.maincartview}>
                    <View>
                        <Text style={styles.boldproduct}>Clothing</Text>
                    </View>
                    <TouchableOpacity>
                        <Text style={styles.salestext}>SEE ALL</Text>
                    </TouchableOpacity>
                ...
                <View style={styles.maincartview}>
                    <View>
                        <Text style={styles.boldproduct}>Furniture</Text>
                    </View>
                    <TouchableOpacity>
                        <Text style={styles.salestext}>SEE ALL</Text>
                    </TouchableOpacity>
                ...
                <View style={styles.maincartview}>
                    <View>
                        <Text style={styles.boldproduct}>Electronis</Text>
                    </View>
                    <TouchableOpacity>
                        <Text style={styles.salestext}>SEE ALL</Text>
                    </TouchableOpacity>
                ...
                <TouchableOpacity>
                    <View style={{marginBottom:'18%',marginLeft:'3%',marginTop:5}}>
                     <FlatList
