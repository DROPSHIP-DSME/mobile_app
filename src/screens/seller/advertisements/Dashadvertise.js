    ...
    return (
       ...
       <ScrollView onScroll={({nativeEvent}) => {
               ...
               <View style={{flexDirection:'row',justifyContent:'space-between',marginHorizontal:'3%',marginTop:'5%'}}>
                 <Text style={{fontSize:26,color:'#1a1a1a',fontFamily:'SourceSansPro-SemiBold',}}>Advertisements</Text>
               </View>

               <View style={{marginHorizontal:'4%',marginTop:'2%'}}>
                 <Text style={{fontSize:18,fontFamily:'SourceSansPro-Regular'}}>Select the parameters you would like to use for this advertisement and the total will adjust.</Text>
               </View>

              <View style={{width:deviceWidth/1.1,backgroundColor:'#ffffff',padding:'5%',alignSelf:'center',marginTop:'7%',borderRadius:15,}}>
                <Text style={{fontSize:18,fontFamily:'SourceSansPro-Regular',color:'#666666'}}>Total Cost of Advertisement</Text>
                
               <Text style={{fontSize:32,fontFamily:'SourceSansPro-SemiBold',color:'#B80000',marginTop:'2%'}}>US $1,000.00</Text>
              ...
              <Text style={{fontSize:12,fontFamily:'SourceSansPro-Regular',color:'4d4d4d',marginLeft:'3%',marginTop:'2%'}}>Type of Advertisement</Text>
                      <Picker
                 ...
                 <View style={styles.pickerViewshorttodayAdvertise}>
              <Text style={{fontSize:12,fontFamily:'SourceSansPro-Regular',color:'4d4d4d',marginLeft:'3%',marginTop:'2%'}}>Advertisement Location</Text>
                      <Picker
                        selectedValue={selectedValue}
                        style={{ height: 20, width: 320,color:'#4d4d4d',}}
                        onValueChange={(itemValue, itemIndex) =>setSelectedValue(itemValue)}
                 ...
                 <View style={styles.pickerViewshorttodayAdvertise}>
              <Text style={{fontSize:12,fontFamily:'SourceSansPro-Regular',color:'4d4d4d',marginLeft:'3%',marginTop:'2%'}}>What are you advertising?</Text>
                      <Picker
                        selectedValue={selectedValue}
                        style={{ height: 20, width: 320,color:'#4d4d4d',}}
                        onValueChange={(itemValue, itemIndex) =>setSelectedValue(itemValue)}
               ...
               <Text style={{fontSize:18,fontFamily:'SourceSansPro-SemiBold',marginHorizontal:'5%'}}>Duration</Text>
