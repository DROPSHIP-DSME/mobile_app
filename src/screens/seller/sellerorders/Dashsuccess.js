    ...
    return (
       ...
       <ScrollView onScroll={({nativeEvent}) => {
               ...
               <View style={{flexDirection:'row',justifyContent:'space-between',marginHorizontal:'3%',marginVertical:'5%'}}>
                 <Text style={{fontSize:26,color:'#1a1a1a',fontFamily:'SourceSansPro-SemiBold',}}>Orders (0)</Text>
               </View>
              ...
              <View style={{marginHorizontal:'4%',marginVertical:'4%',flexDirection:'row'}}>
               <View style={[styles.pickerViewshorttodayagainorder,{flexDirection:'row',justifyContent:'space-around',padding:4}]}>
                  <View style={{height:14,width:14,backgroundColor:'#ffffff',borderRadius:3,marginTop:3}}></View>
                   <Text style={{fontSize:16,fontFamily:'SourceSansPro-Regular',paddingHorizontal:10,textAlign:'center',color:'#ffffff'}}>Select All</Text> 
                </View>
                ...
                <Text style={{marginHorizontal:'4%',marginVertical:'5%',fontSize:16,fontFamily:'SourceSansPro-Regular'}}>You have no Orders Currently</Text>   
               </ScrollView>
