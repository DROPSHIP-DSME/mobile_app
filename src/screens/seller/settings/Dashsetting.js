    ...
    return (
       ...
       <ScrollView onScroll={({nativeEvent}) => {
               ...
               <View style={{flexDirection:'row',justifyContent:'space-between',marginHorizontal:'3%',marginVertical:'5%'}}>
                 <Text style={{fontSize:26,color:'#1a1a1a',fontFamily:'SourceSansPro-SemiBold',}}>Settings</Text>
               </View>
              ...
              <View style={{width:deviceWidth/1.1,backgroundColor:'#ffffff',padding:'3%',alignSelf:'center',marginTop:'5%',borderRadius:15,}}>
                   ...
                   <View style={{flexDirection:'row',justifyContent:'space-between',marginVertical:'3%'}}>
                     <Text style={{fontSize:22,color:'#1a1a1a',fontFamily:'SourceSansPro-SemiBold',}}>Brand Profile</Text>
               ...
               <View style={{flexDirection:'row',justifyContent:'space-between',marginTop:'4%'}}>
                  <Text style={{fontSize:16,fontFamily:'SourceSansPro-SemiBold',color:'#666666'}}>Brand Photo</Text>
               ...
               <View style={{flexDirection:'row',justifyContent:'space-between',}}>
                  <Text style={{fontSize:16,fontFamily:'SourceSansPro-SemiBold',color:'#666666'}}>Brand Name</Text>
                   <Text style={{fontSize:16,fontFamily:'SourceSansPro-Regular',color:'#1a1a1a'}}>Sneakers Store</Text>
               </View>

               <View style={{borderBottomWidth:2,borderColor:'#e6e6e6',width:'100%',alignSelf:'center',marginVertical:'4%'}}></View>

                <View style={{flexDirection:'row',justifyContent:'space-between',}}>
                  <Text style={{fontSize:16,fontFamily:'SourceSansPro-SemiBold',color:'#666666'}}>Category</Text>
                  <Text style={{fontSize:16,fontFamily:'SourceSansPro-Regular',color:'#1a1a1a'}}>Shoes</Text>
               </View>

               <View style={{borderBottomWidth:2,borderColor:'#e6e6e6',width:'100%',alignSelf:'center',marginVertical:'4%'}}></View>

                <View style={{flexDirection:'row',justifyContent:'space-between',}}>
                  <Text style={{fontSize:16,fontFamily:'SourceSansPro-SemiBold',color:'#666666'}}>Description</Text>
                   <Text style={{fontSize:16,fontFamily:'SourceSansPro-Regular',color:'#1a1a1a',width:200}}>Lorem ipsum dolor sit today amet,consectetur adipiscing elit.Pulvinar dictum quisque id sit ut.</Text>
               </View>
              ...
              <View style={{width:deviceWidth/1.1,backgroundColor:'#ffffff',padding:'3%',alignSelf:'center',marginTop:'12%',borderRadius:15,marginBottom:'25%'}}>
                   ...
                   <View style={{flexDirection:'row',justifyContent:'space-between',marginVertical:'3%'}}>
                     <Text style={{fontSize:22,color:'#1a1a1a',fontFamily:'SourceSansPro-SemiBold',}}>Account Settings</Text>
                   </View> 
               <TouchableOpacity  onPress={() => props.navigation.navigate("Dashimport")} style={{flexDirection:'row',justifyContent:'space-between',marginTop:'4%'}}>
                  <Text style={{fontSize:16,fontFamily:'SourceSansPro-SemiBold',color:'#666666'}}>Import Data</Text>
               ...
               <TouchableOpacity  onPress={() => props.navigation.navigate("Dashsupport")} style={{flexDirection:'row',justifyContent:'space-between',}}>
                  <Text style={{fontSize:16,fontFamily:'SourceSansPro-SemiBold',color:'#666666'}}>Customer Support</Text>
                  <Image source={ImageIcons.blackrighttoday} style={{width:11,height:11,marginTop:5}}/>
               </TouchableOpacity>
               ...
               <TouchableOpacity  onPress={() => deleetaccount() } >
                <View style={{flexDirection:'row',justifyContent:'space-between',marginBottom:'5%'}}>
                  <Text style={{fontSize:16,fontFamily:'SourceSansPro-SemiBold',color:'#666666'}}>Delete Account</Text>
                 <Image source={ImageIcons.blackrighttoday} style={{width:11,height:11,marginTop:5}}/>
               </View>
               </TouchableOpacity>
              </View>
