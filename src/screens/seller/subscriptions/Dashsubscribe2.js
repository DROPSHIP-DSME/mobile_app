    ...
    return (
       ...
       <ScrollView onScroll={({nativeEvent}) => {
               ...
               <View style={{flexDirection:'row',justifyContent:'space-between',marginHorizontal:'3%',marginTop:'5%'}}>
                 <Text style={{fontSize:22,color:'#1a1a1a',fontFamily:'SourceSansPro-SemiBold',}}>Subscriptions</Text>
               </View>
            ...
            <View style={{flexDirection:'row',justifyContent:'space-around',marginHorizontal:5,marginTop:'5%'}}>
              <View style={{width:'46%',padding:'5%',backgroundColor:'#ffffff',borderRadius:15}}>
                <Text style={{fontSize:18,fontFamily:'SourceSansPro-Regular',color:'#666666',textAlign:'center'}}>Current</Text>
                <Text style={{fontSize:18,fontFamily:'SourceSansPro-Regular',color:'#666666',textAlign:'center'}}>Subscription</Text>
                <Text style={{fontSize:22,fontFamily:'SourceSansPro-SemiBold',color:'#1a1a1a',textAlign:'center',marginTop:'2%'}}>Pro Tier</Text>
                <Text style={{fontSize:18,fontFamily:'SourceSansPro-Regular',color:'#1a1a1a',textAlign:'center'}}>$35/month</Text>
                ...
                <Text style={{fontSize:14,fontFamily:'SourceSansPro-SemiBold',color:'#666666',textAlign:'center',marginTop:'5%'}}>Cancel</Text>   
              </View>

              <View style={{width:'46%',padding:'5%',backgroundColor:'#ffffff',borderRadius:15}}>
                <Text style={{fontSize:18,fontFamily:'SourceSansPro-Regular',color:'#666666',textAlign:'center'}}>SMS</Text>
                               <Text style={{fontSize:18,fontFamily:'SourceSansPro-Regular',color:'#666666',textAlign:'center'}}>Bundle</Text>

               <Text style={{fontSize:20,fontFamily:'SourceSansPro-SemiBold',color:'#1a1a1a',textAlign:'center',marginTop:'2%'}}>245/2500</Text>
                <Text style={{fontSize:22,fontFamily:'SourceSansPro-SemiBold',color:'#1a1a1a',textAlign:'center',marginTop:'2%'}}>SMS left</Text>
             ...
             <Text style={{fontSize:22,color:'#1a1a1a',fontFamily:'SourceSansPro-SemiBold',marginHorizontal:'4%',marginTop:'7%'}}>Recent SMS Campaigns</Text>

             <View style={{width:deviceWidth/1.1,backgroundColor:'#ffffff',padding:'5%',alignSelf:'center',marginTop:'7%',borderRadius:15,}}>
                <Text style={{fontSize:18,fontFamily:'SourceSansPro-Regular',color:'#666666'}}>25 - 01 - 2022</Text>
                ...
                <Text style={{fontSize:22,color:'#1a1a1a',fontFamily:'SourceSansPro-SemiBold',marginTop:'2%'}}>New Product Launch!</Text>
                <Text style={{fontSize:18,fontFamily:'SourceSansPro-Regular'}}>Dropship gives you the option of increase the value of your livestreaming exprience through additional marketing features. Select the plan that best suits your goals.</Text>
                 <View style={{backgroundColor:'#e6e6e6',width:120,borderRadius:10,padding:8,marginTop:'2%'}}>
                      <Text style={[styles.totalincometodayPLAN,{color:'#000000'}]}>342 SMS SENT</Text> 
                   </View>
