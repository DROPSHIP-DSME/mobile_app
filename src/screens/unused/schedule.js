...
shadowOffset: {width: 0,height: 2,},shadowOpacity: 0.25,shadowRadius: 3.84,elevation: 5}}>
          ...
          <View>
            <Text style={{color:'#000000',fontSize:15,fontFamily:'SourceSansPro-SemiBold',lineHeight:19}}>{item.productName}</Text>
            <Text style={{color:'#000000',fontSize:12,fontFamily:'SourceSansPro-Regular',lineHeight:15}}>${item.productPrice}</Text>
          </View>
        </View>      
    </View> 
  );
                ...
                <View style={{marginTop:'2%',flexDirection: 'row',}}>
                   <TouchableOpacity  onPress={() => {props.navigation.navigate("StartRecording") }}> 
                    ...
                    <View style={{ marginBottom:10,paddingLeft:10, marginTop:10,flexDirection:'row', justifyContent:'space-between', width:'100%', borderWidth:1,borderRadius:5, borderColor:'#ABABAB'}}>
                        ...
                        <Picker
                            selectedValue={hours}
                            style={{ paddingLeft:10, width: '90%', borderColor:'#f9f9f9',borderWidth:1,fontSize:10,fontFamily:'SourceSansPro-Regular' }}
